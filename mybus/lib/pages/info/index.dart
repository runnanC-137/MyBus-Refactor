          ...
          children: [
            Table(
              children: [
                ...
                _criarLinhaTable(
                    "Este é um projeto da UNIFESSPA que tem como objetivo ser uma alternativa para localização do transporte público para qualquer cidade, onde qualquer pessoa pode compartilhar sua localização quando estiver utilziando um ônibus, táxi lotação ou moto táxi, com os demais usuários.",
                    false),
                _divisor(),
                _criarLinhaTable("Termo de Uso", true),
                TableRow(
                  children: [
                    'https://drive.google.com/file/d/1Ns2GtxHX-0D3xi7rSZ02SKeGS06aPWMr/view?usp=sharing'
                  ].map((url) {
                    return Container(
                      alignment: Alignment.center,
                      ...
                      child: ElevatedButton.icon(
                        ...
                        onPressed: () async {
                          await canLaunch(url)
                              ? await launch(url)
                              : throw 'Não conseguiu iniciar $url';
                        },
