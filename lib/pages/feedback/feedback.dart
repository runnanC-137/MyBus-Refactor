                    ...
                    children: [
                      TextFormField(
                        ...
                        validator: (valor) {
                          return Validador()
                              .maxLength(50,
                                  msg:
                                      "Por favor, seja objetivo e claro... máximo de 50 caracteres!")
                      ...
                      TextFormField(
                        decoration: const InputDecoration(
                            labelText: "Mensagem",
                            hintText:
                                "Sinta-se livre para escrever sua opinião!"),
                        controller: _msg,
                        maxLength: 500,
                        maxLines: null,
                        validator: (valor) {
                          return Validador()
                              .maxLength(500,
                                  msg:
                                      "Por favor, seja objetivo e claro... máximo de 500 caracteres!")
                              .minLength(25,
                                  msg:
                                      "Não poupe palavras... mínimo de 25 caracteres!")
                              .add(Validar.OBRIGATORIO,
                                  msg: "Campo Obrigatório")
                              .valido(valor);
                        },
