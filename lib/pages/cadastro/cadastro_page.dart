...
import 'package:mybus/classes/Usuario.dart';
                  ...
                  child: Row(
                    ...
                    children: [
                      ElevatedButton.icon(
                        ...
                        label: Text("Termo de Uso"),
                        onPressed: () async {
                          await canLaunch(_url)
                              ? await launch(_url)
                              : throw 'Não conseguiu iniciar $_url';
                        },
                      ),
                    ],
                  ),
                            ...
                            firebase
                              ...
                              firebase
                                ...
                                firebase
                                  ...
                                  print(error);
                                  final snackBar = SnackBar(
                                    content: Text("Usuário e/ou Senha errado!"),
                                  );
                                  ScaffoldMessenger.of(context)
                                      .showSnackBar(snackBar);
                                });
                              ...
                              final snackBar = SnackBar(
                                ...
                                content: Text("Houve um erro ao cadastrar!"),
                              );
                              ScaffoldMessenger.of(context)
                                  .showSnackBar(snackBar);
                            });
